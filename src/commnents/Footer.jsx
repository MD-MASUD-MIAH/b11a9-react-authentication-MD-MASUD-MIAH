...
const Footer = () => {
    return (
      <footer className=" gap-5 flex flex-col justify-center
       items-center bg-neutral text-neutral-content p-10"> 

   
                <div className="  flex font-bold items-center gap-3 md:text-xl mr-7 "><img className={`w-18 filter invert  brightness-0 " `}  src={logo} alt="" /> <p className='md:mt-4'>Event Explorer</p></div> 
